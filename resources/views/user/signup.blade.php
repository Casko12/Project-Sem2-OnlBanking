                    ...
                    <div class="bg-white shadow-md rounded p-3 pt-sm-4 pb-sm-5 px-sm-5">
                        ...
                        <form id="signupForm" method="post" action="{{url("/store")}}" role="form">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="national_id" id="national_id" required placeholder="Enter Your NationalID">
                            </div>
                            <div class="mb-3">
                                <label for="telephone" class="form-label">Số Điện Thoại</label>
                                <input type="text" class="form-control" name="telephone" id="telephone" required placeholder="Enter Your Telephone">
                            </div>
                            <div class="mb-3">
