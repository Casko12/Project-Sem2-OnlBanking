...
<head>
    ...
    <!-- Stylesheet
    ============================================= -->
    <link rel="stylesheet" href="user/user-page/vendor/bootstrap/css/bootstrap.min.css" />
    <link rel="stylesheet" href="user/user-page/vendor/font-awesome/css/all.min.css" />
    <link rel="stylesheet" href="user/user-page/css/stylesheet.css" />
    <!-- Colors Css -->
        ...
        <div class="container">
            <div class="header-row">
                <div class="header-column justify-content-start">
                    <!-- Logo
                    ============================= -->
                    <div class="logo me-3"> <a class="d-flex" href="user/user-page/index.html" title="Payyed - HTML Template"><img src="user/user-page/images/mbanking-03.png" alt="Modern Bank" /></a> </div>
                    <!-- Logo end -->
                    <!-- Collapse Button
                    ============================== -->
